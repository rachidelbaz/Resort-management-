...
namespace ResortManagement
{
    ...
    public class ApplicationUserManager : UserManager<RMUser>
    {
        public ApplicationUserManager(IUserStore<RMUser> store)
            : base(store)
        {
        }
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<RMUser>(context.Get<ResortManagementDbContext>()));
    ...
    public class ApplicationSignInManager : SignInManager<RMUser, string>
    {
